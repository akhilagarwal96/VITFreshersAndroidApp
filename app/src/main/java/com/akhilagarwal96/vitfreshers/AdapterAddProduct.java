...
public class AdapterAddProduct extends ArrayAdapter{

    public AdapterAddProduct(Activity context, String txt_name, String txt_room, String txt_phone, String txt_desc) {
    ...
    public View getView(int position,View view,ViewGroup parent) {
        ...
        EditText Room = (EditText) rowView.findViewById(R.id.sell_location);
